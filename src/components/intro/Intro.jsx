        ...
        <div className="i" id="intro">
                ...
                <div className="i-left-wrapper">
                    ...
                    <div className="i-title">
                        <div className="i-title-wrapper">
                            <div className="i-title-item">Engenheiro de Computação</div>
                            <div className="i-title-item">Desenvolvedor Web FullStack</div>
                        </div>
                    </div>
                    <p className="i-desc">
                        Sou Engenheiro de Computação, formado pela Universidade Federal de Itajubá, e Desenvolvedor Web Fullsatack. Aqui você vai encontrar um pouco do meu portfólio e do meu currículo :)
                    </p>
                    {/*<p className="i-nav">
            ...
            <div className="i-right">
                ...
                <div className="i-contact">
                    <h1 className="i-contact-title">Contato</h1>
                    <div className="i-contact-info">
                        <div className="i-contact-info-item">
            ...
            <div className="custom-shape-divider-bottom-1645673969">
